...
var options3 = {
  ...
  xaxis: {
    categories: ["Feeeb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct"],
  },
  yaxis: {
    title: {
      text: "$ (thousands)",
...
var options = {
  ...
  colors: [dunzoAdminConfig.primary, dunzoAdminConfig.secondary, "#51bb25", "#f8d62b"],
};
...
var options8 = {
  ...
  labels: ["Online", "Offline", "Dropship"],
  series: [4373, 657, 512],
  responsive: [
    {
      breakpoint: 480,
...
var options11 = {
  ...
  colors: [dunzoAdminConfig.secondary, "#51bb25", "#f8d62b", dunzoAdminConfig.primary],
};
