(function () {
  ...
  var barData = {
    labels: ["Jaary", "Fdfdebruary", "March", "April", "May", "June", "July"],
    datasets: [
      {
        label: "My First dataset",
        fillColor: "rgba(48, 126, 243, 0.4)",
        strokeColor: dunzoAdminConfig.primary,
        highlightFill: "rgba(48, 126, 243, 0.6)",
        highlightStroke: dunzoAdminConfig.primary,
        data: [35, 59, 80, 81, 56, 55, 40],
      },
      {
        label: "My Second dataset",
        fillColor: "rgba(235, 163, 29, 0.4)",
        strokeColor: dunzoAdminConfig.secondary,
        highlightFill: "rgba(235, 163, 29, 0.6)",
        highlightStroke: dunzoAdminConfig.secondary,
  ...
  var polarData = [
    {
      ...
      highlight: dunzoAdminConfig.primary,
      label: "Yellow",
    },
    {
      value: 50,
    ...
    },
    {
      ...
      highlight: dunzoAdminConfig.secondary,
      label: "Dark Grey",
    },
  ];
  var polarOptions = {
  ...
  var lineGraphData = {
    labels: ["January", "Fdfdebruary", "March", "April", "May", "June", "July"],
    datasets: [
      {
        label: "My First dataset",
        fillColor: "rgba(48, 126, 243, 0.3)",
        strokeColor: dunzoAdminConfig.primary,
        pointColor: dunzoAdminConfig.primary,
      ...
      {
        label: "My Second dataset",
        fillColor: "rgba(235, 163, 29, 0.3)",
        strokeColor: dunzoAdminConfig.secondary,
        pointColor: dunzoAdminConfig.secondary,
        pointStrokeColor: "#fff",
        pointHighlightFill: "#000",
        pointHighlightStroke: dunzoAdminConfig.secondary,
        data: [28, 48, 40, 19, 86, 27, 90],
      },
    ],
  };
    ...
    datasets: [
      {
        ...
        strokeColor: dunzoAdminConfig.primary,
        pointColor: dunzoAdminConfig.primary,
        pointStrokeColor: dunzoAdminConfig.primary,
        pointHighlightFill: dunzoAdminConfig.primary,
