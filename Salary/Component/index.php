...
<head>
  ...
  $query = "SELECT mastercomponent FROM useraccesslevel WHERE UserID = '$userID'";
  $result = mysqli_query($conn, $query);
  $row = mysqli_fetch_assoc($result);

  $hasCRUDAccess = strpos($row['mastercomponent'], 'C') !== false || // Create
    strpos($row['mastercomponent'], 'R') !== false || // Read
    strpos($row['mastercomponent'], 'U') !== false || // Update
    strpos($row['mastercomponent'], 'D') !== false;  // Delete
            ...
            <div class="page-title">
              ...
              if (isset($_GET["status"])) {
                if ($_GET["status"] == "success") {
                  ...
                  <p><b> Selamat! </b>Komponen gaji baru berhasil disimpan ke database.</p>
              ...
              <div class="row">
                ...
                <div class="col-sm-6 pe-0">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">Komponen Gaji</li>
                  </ol>
                </div>
              </div>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                $canUpdate = false;
                                if (!empty($userID)) {
                                $query_access = "SELECT mastercomponent FROM useraccesslevel WHERE UserID = '$userID'";
                                $result_access = mysqli_query($conn, $query_access);
                                if ($result_access) {
                                    $row_access = mysqli_fetch_assoc($result_access);
                                    $access_level = $row_access['mastercomponent'];
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title" id="myExtraLargeModal">Form Komponen Baru</h4>
                                                <button class="btn-close py-0" type="button" data-bs-dismiss="modal"
                                                aria-label="Close"></button>
                                            </div>
                                            <div class="modal-body dark-modal">
                                                <div class="card-body custom-input">
                                                    <form class="row g-3" action="../Process/createSalaryComponent.php" method="POST">
                                                        <div class="col-6"> 
                                                            <label class="form-label" for="code">Kode Komponen</label>
                                                            <input class="form-control" id="code" name="code" type="text" placeholder="-" aria-label="First name" required>
                                                        </div>
                                                        <div class="col-6">
                                                            <label class="form-label" for="type">Jenis Komponen</label>
                                                        ...
                                                        <div class="col-12"> 
                                                            <label class="form-label" for="name">Nama Komponen</label>
                                                            <input class="form-control" id="name" name="name" type="text" placeholder="-" aria-label="First name" required>
                                                        </div>
                                                        <hr>
                                                        <div class="col-12"> 
                                ...
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade show active" id="daftarBarang" role="tabpanel">
                                        ...
                                        <table class="display" id="basic-12">
                                            ...
                                            <tbody>
                                            <?php
                                            $query = "SELECT * FROM salarycomponent";
                                            $result = mysqli_query($conn, $query);
