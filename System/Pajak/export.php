...
<head>
  ...
  $query = "SELECT exportTax FROM useraccesslevel WHERE UserID = '$userID'";
  $result = mysqli_query($conn, $query);
  $row = mysqli_fetch_assoc($result);

  $hasCRUDAccess = strpos($row['exportTax'], 'C') !== false || // Create
    strpos($row['exportTax'], 'R') !== false || // Read
    strpos($row['exportTax'], 'U') !== false || // Update
    strpos($row['exportTax'], 'D') !== false;  // Delete
              ...
              <div class="page-body">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-4">
                              <div class="card-wrapper border rounded-3 checkbox-checked">
                                <h6 class="sub-title">Silahkan pilih format export pajak!</h6>
                                <label class="d-block" for="chk-ani"></label>
                                <input class="checkbox_animated" id="chk-ani" name="formEFaktur" value="efaktur" type="checkbox">E-FAKTUR
                                <label class="d-block" for="chk-ani1"></label>
                                <input class="checkbox_animated" id="chk-ani1" name="formCoretax" value="coretax" type="checkbox" checked>CORETAX 
                              </div>
                            </div>
                          </div>
                          <button class="btn btn-primary" name="btnSearch"><i class="fa fa-download"></i> Export</button>
                          <button class="btn btn-secondary" name="btnSearch3"><i class="fa fa-download"></i> Report</button>
                        </form>
                      </div>
                    </div>
                  </div>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="card">
                      <div class="card-header">
                        <h3>FAKTUR UANG MUKA</h3>
                      </div>
                      <div class="card-body">
                        <form class="form theme-form" action="../Process/export-dp-excel.php" method="POST">
                          <div class="row">
                            <div class="col-md-4">
                              <div class="row">
                                <div class="mb-3 row">
                          ...
                          <button class="btn btn-primary" name="btnSearch2"><i class="fa fa-download"></i> Export</button>
                          <button class="btn btn-secondary" name="btnSearch4"><i class="fa fa-download"></i> Export</button>
                        </form>
                      </div>
                    </div>
                  </div>
