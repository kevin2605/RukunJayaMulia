                                    ...
                                    <form class="row g-3" action="../Process/editSupportingGoods.php" method="POST">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <input class="form-control" id="namabarang" name="namabarang" type="text"
                                                <?php echo "value='".$goods["GoodsName"]."'"; ?> placeholder="barang contoh"
                                                readonly>
                                        </div>
                                        <div class="col-3">
                                        ...
                                        <div class="col-3">
                                            <label class="col-sm-12 col-form-label" for="satuanpertama">Satuan Kedua<span
                                                    style="color:red;">*</span></label>
                                            <input class="form-control" id="satuanpertama" list="satuanOptions"
                                                name="satuan" value="<?php echo $goods["UnitCD_2"]; ?>"
                                                placeholder="Satuan" readonly>
                                            <datalist id="satuanOptions">
                                                <?php
                                                $query = "SELECT UnitCD,UnitName FROM unit WHERE Status='1'";
                                        ...
                                        <div class="col-3">
                                            ...
                                            <input class="form-control" id="buyprice" name="buyprice" type="text"
                                                value="Rp <?php echo number_format($goods["BuyPrice"], 0, ',', '.'); ?>" placeholder="0" readonly>
                                        </div>
                                        <div class="col-3">
                                            ...
                                            <input class="form-control" id="usetax" name="usetax" type="text" <?php if ($goods["Tax"] == 0) {
                                                ...
                                                echo 'value="Rp ' . number_format($goods["BuyPrice"]* 1.11, 0, ',', '.')  . '"';
                                            } ?> readonly>
                                        </div>
                                        <div class="col-3">
                                            <label class="form-label" for="avgprice">Harga Avg
                                            <input class="form-control" id="avgprice" name="avgprice" type="text"
                                                value="Rp <?php echo number_format($goods["AvgPrice"], 0, ',', '.'); ?>" placeholder="0" readonly>
                                        </div>
                                        <div class="col-6">
