                                                                    ...
                                                                    while ($row = mysqli_fetch_array($result)) {
                                                                        echo '
                                                                            <tr>
                                                                                ...
                                                                                <td> 
                                                                                    <ul> 
                                                                                        <button style="padding:5px 10px 5px 10px;" onclick="viewPart(this)" type="button" class="light-card border-primary border b-r-10" value="' . $row["PartCD"] . '"><i class="fa fa-eye txt-primary"></i></button>';
                                                                        if ($can_updatee) {
                                                                            echo '<button style="padding:5px 10px 5px 10px;" onclick="editPart(this)" type="button" class="light-card border-warning border b-r-10" value="' . $row["PartCD"] . '"><i class="icon-pencil-alt txt-warning"></i></button>';
                                                                        }
                                                                        echo '
                                                                                    </ul>
                                                                                </td>
