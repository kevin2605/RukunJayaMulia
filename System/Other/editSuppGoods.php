                                    ...
                                    <form class="row g-3" action="../Process/editSupportingGoods.php" method="POST">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <input class="form-control" id="namabarang" name="namabarang" type="text"
                                                <?php echo "value='".$goods["GoodsName"]."'"; ?>
                                        ...
                                        <div class="col-3">
                                            <label class="col-sm-12 col-form-label" for="satuankedua">Satuan Kedua<span
                                                    style="color:red;">*</span></label>
                                            <input class="form-control" id="satuankedua" list="satuanOptions"
                                                name="satuan2" value="<?php echo $goods["UnitCD_2"]; ?>"
                                                placeholder="Satuan2" required>
                                            <datalist id="satuanOptions">
                                                <?php
                                                $query = "SELECT UnitCD,UnitName FROM unit WHERE Status='1'";
                                                $result = mysqli_query($conn, $query);
                                        ...
                                        <div class="col-3">
                                            ...
                                            <input class="form-control" id="avgprice" name="avgprice" type="text"
                                                value="<?php echo $goods["AvgPrice"]; ?>" placeholder="0" readonly>
                                        </div>
                                        <div class="col-6">
