...
<head>
  ...
  <script>
    ...
    function printInv(button) {
      ...
      var url = "../Process/generate_invoicing_pdf.php?RCV_InvoiceID=" + RCV_InvoiceID;
                              ...
                              <table class="display" id="basic-1">
                                ...
                                <tbody>
                                  ...
                                  while ($rowR = mysqli_fetch_array($resultR)) {
                                    ...
                                    echo ' <button style="padding:5px 10px 5px 10px;" onclick="printInv(this)" type="button" class="light-card border-info border b-r-10" value="' . $rowR["RCV_InvoiceID"] . '"><i class="fa fa-print txt-info"></i></button>
                                            </ul>
                                          </td>
                                      </tr>';
                                  }
