                    ...
                    <div class="page-title">
                        <div class="row">
                            <div class="col-sm-6 ps-0">
                                <h3>EDIT PURCHASE ORDER MATERIAL</h3>
                            </div>
                            <div class="col-sm-6 pe-0">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">Edit PO Material</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card height-equal">
                                <div class="modal-body dark-modal">
                                    <div class="card-body custom-input">
                                        ...
                                        <form class="row g-3" action="../Process/updatePOMaterial.php" method="POST">
                                            <?php
                                            include "../DBConnection.php";
                                            ...
                                            $queryDetails = "SELECT * FROM purchaseorderdetail WHERE PurchaseOrderID = '$purchaseOrderID'";
