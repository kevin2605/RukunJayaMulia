...
<head>
    ...
    <script>
        ...
        function appendProductTable(x) {
            ...
            $.ajax({
                ...
                success: function (result) {
                    var res = JSON.parse(result);
                    $.each(res, function (index, value) {
                        x.parentElement.parentElement.cells[3].getElementsByTagName("input")[0].value = formatRupiah(value.BuyPrice);
                    });
                }
            });
        }
        ...
        function printPO(str) {
            ...
            var url = "../Process/generate_POL_pdf.php?PurchaseOrderID=" + purchaseOrderID;
            window.open(url, '_blank');
        }

        function editPO(str) {
            var purchaseOrderID = str.value;
            var url = "../Local-Purchasing/edit-purchasing-material.php?PurchaseOrderID=" + purchaseOrderID;
        ...
        function countSubtotal(x) {
            ...
            var harga = x.parentElement.parentElement.cells[3].getElementsByTagName("input")[0].value.replace(/[^,\d]/g, '').toString();
            let subtotal = harga * jumlah;

            x.parentElement.parentElement.cells[4].getElementsByTagName("input")[0].value = formatRupiah(subtotal);
        }
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="tab-content" id="myTabContent">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    while ($rowPO = mysqli_fetch_array($resultSO)) {
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="text-end">' . number_format($rowPO["TotalPurchase"], 2, ',', '.') . '</td>';
                                                                        ...
                                                                        if ($can_print && strpos($creator, 'ADM') !== false) {
                                                                            ...
                                                                            <button style="padding:5px 10px 5px 10px;" onclick="viewPO(this)" type="button" class="light-card border-primary border b-r-10 action-button" value="' . $rowPO["PurchaseOrderID"] . '"><i class="fa fa-eye txt-primary"></i></button>
                                                                            <button style="padding:5px 10px 5px 10px;" onclick="printPO(this)" type="button" class="light-card border-info border b-r-10 action-button" value="' . $rowPO['PurchaseOrderID'] . '"><i class="fa fa-print txt-info"></i></button>';
                                                                        }
                                                                        if ($can_update) {
                                                                            echo ' 
                                                                            <button style="padding:5px 10px 5px 10px;" onclick="editPO(this)" type="button" style="margin-right: 2px;" class="light-card border-warning border b-r-10 action-button" value="' . $rowPO["PurchaseOrderID"] . '"><i class="fa fa-pencil-square-o txt-warning"></i></button>
                                                                            
                                                                            ';
                                                                        }

                                                                        echo '</ul></td></tr>';
                                                                        $tAmount += $rowPO["TotalPurchase"];
                                                                    }
                                                                    ?>
                                                                </tbody>
                                                            </table>
                                                    ...
                                                    <div class="tab-pane fade" id="penerimaanBarang" role="tabpanel">
                                                            ...
                                                            <table class="display" id="basic-1">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    while ($rowPO = mysqli_fetch_array($resultSO)) {
                                                                        ...
                                                                        echo '</ul></td></tr>';
                                                                        $tAmountComplete += $rowPO["TotalPurchase"];
                                                                    }
                                                                    ?>
                                                                </tbody>
                                                            </table>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-10"></div>
                                                            <div class="col-2">Total Nominal : <?php echo 'Rp ' . number_format($tAmountComplete,0,'.',','); ?></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
