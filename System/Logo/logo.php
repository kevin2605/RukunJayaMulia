...
<head>
    ...
    $query = "SELECT Logo FROM useraccesslevel WHERE UserID = '$userID'";
    $result = mysqli_query($conn, $query);
    $row = mysqli_fetch_assoc($result);

    // Cek akses CRUD dan tentukan apakah akses diizinkan
    $hasCRUDAccess = strpos($row['Logo'], 'C') !== false || // Create
        strpos($row['Logo'], 'R') !== false || // Read
        strpos($row['Logo'], 'U') !== false || // Update
        strpos($row['Logo'], 'D') !== false;  // Delete
                                ...
                                <div class="container-fluid">
                                    <div class="page-title">
                                        ...
                                        if (isset($_GET["status"])) {
                                            if ($_GET["status"] == "success") {
                                                echo '<div class="alert txt-success border-success outline-2x alert-dismissible fade show alert-icons" role="alert">
                                                <p><b> Selamat! </b>Logo baru berhasil disimpan ke database.</p>
                                                <button class="btn-close" type="button" data-bs-dismiss="alert" aria-label="Close"></button>
                                                </div>';
                                            } else if ($_GET["status"] == "error") {
                                                echo '<div class="alert txt-danger border-danger outline-2x alert-dismissible fade show alert-icons" role="alert">
                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                $canUpdate = false;
                                                if (!empty($userID)) {
                                                    $query_access = "SELECT Logo FROM useraccesslevel WHERE UserID = '$userID'";
                                                    $result_access = mysqli_query($conn, $query_access);
                                                    if ($result_access) {
                                                        $row_access = mysqli_fetch_assoc($result_access);
                                                        $access_level = $row_access['Logo'];
                                                    ...
                                                    <div class="modal-dialog modal-lg">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h4 class="modal-title" id="cityModalLabel">Form Nama
                                                                    Logo
                                                                    Baru</h4>
                                                            ...
                                                            <div class="modal-body dark-modal">
                                                                <div class="card-body custom-input">
                                                                    <form class="row g-3"
                                                                        action="../Process/createlogo.php"
                                                                        method="POST">
                                                                        <div class="col-12">
                                                                            <label class="form-label"
                                                                                for="namalogo">Nama Logo</label>
                                                                            <input class="form-control" id="namalogo"
                                                                                name="namalogo" type="text"
                                                ...
                                                <ul class="dropdown-menu dropdown-block" id="myTab" role="tablist">
                                                    <li class="nav-item"><a
                                                            ...
                                                            role="tab" aria-controls="home" aria-selected="true">Daftar
                                                            Nama Logo</a></li>
                                                </ul>
                                                <hr>
