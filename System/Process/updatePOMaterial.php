...
if ($resulth && $resultd) {
    header("Location:../Local-Purchasing/purchasing-material.php?status=success-update");
} else {
    header("Location:../Local-Purchasing/purchasing-material.php?status=error-update");
}
