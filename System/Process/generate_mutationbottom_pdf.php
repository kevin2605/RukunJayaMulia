...
if (isset($_GET['MutationID'])) {
    ...
    SELECT 
        ...
        md.UnitCD_1 AS Satuan, 
        md.Description AS Keterangan 
    FROM 
        mutationdetailbtm md
    JOIN 
    ...
    $pdf->SetXY(15, 15);
    $pdf->Cell(0, 10, 'PT. INDOPACK MULTI PERKASA                    Mutasi  Bottom                     ', 0, 1, 'C');
    ...
    $pdf->SetXY(90, 25);
    $pdf->SetX(130);
    $pdf->Cell(0, 6, 'No. Mutasi              : ' . $header['MutationID'], 0, 1);
    $pdf->SetX(130);
    $pdf->Cell(0, 6, 'Tipe Mutasi             : Bottom', 0, 1);
    $pdf->SetX(130);
    $pdf->Cell(0, 6, 'Tgl. Mutasi              : ' . $header['CreatedOn'], 0, 1);
    $pdf->SetX(130);
    $pdf->MultiCell(0, 6, 'Keterangan             : ' . $header['Description'], 0, 1);
    $pdf->Ln(10);
