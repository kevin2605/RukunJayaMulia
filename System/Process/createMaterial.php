...
$query = "INSERT INTO `material`(`MaterialCD`, `MaterialName`, `Sequence`, `StockQty`, `CategoryCD`, `GroupCD`, `UnitCD_1`, `UnitCD_2`, `WarehCD`, `SupplierNum`, `Desc_1`, `Desc_2`, `Desc_3`,`BuyPrice`, `Sales`, `Purchase`, `Production`, `Transaction`, `Status`, `CreatedBy`, `CreatedOn`, `LastEdit`) 
VALUES ('$kodebahan','$namabahan','$urutanreport','0','$kategori','$group','$satuanpertama','$satuankedua','$gudang','$supplier','$keterangan1','$keterangan2','$keterangan3','$buyprice','$rulesjual','$rulesbeli','$rulesproduksi','$rulestransaksi','$status','$creator','$createdOn','$createdOn')";
