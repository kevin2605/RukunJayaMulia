...
<head>
    ...
    <script>
        function getLedgerAmt(group) {
            var groupcd = group.value.split(" - ")[0];
            console.log(groupcd);
            $.ajax({
                type: "POST",
                url: "../Process/getLedgerAmt.php",
                data: "groupcd=" + groupcd,
                success: function (result) {
                    var res = JSON.parse(result);
                    $.each(res, function (index, value) {
                        document.getElementById("remaining").value = value.RemainingAmount;
                        document.getElementById("unit").value = value.UnitCD;
                    });
                }
            });
        }
                                            ...
                                            <div class="modal-dialog modal-xl">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h4 class="modal-title" id="myExtraLargeModal">Surat Perintah Kerja Baru</h4>
                                                        <button class="btn-close py-0" type="button"
                                                            data-bs-dismiss="modal" aria-label="Close"></button>
                                                    </div>
                                                    <div class="modal-body dark-modal">
                                                        <div class="card-body custom-input">
                                                            <form class="row g-3" action="../Process/createProdOrder.php" method="POST">
                                                                <div class="col-4">
                                                                    <div class="col-12">
                                                                        <label class="form-label" for="machinecd">Nomor SPK<span style="color:red;">*</span></label>
                                                                ...
                                                                <div class="col-8" style="border-left:1px solid black;">
                                                                    <ul class="simple-wrapper nav nav-tabs" id="myTab" role="tablist">
                                                                        <li class="nav-item"><a class="nav-link active txt-primary" id="home-tab" data-bs-toggle="tab" href="#bahan" role="tab" aria-controls="home" aria-selected="true">Bahan</a></li>
                                                                        <li class="nav-item"><a class="nav-link txt-primary" id="profile-tabs" data-bs-toggle="tab" href="#mesin" role="tab" aria-controls="profile" aria-selected="false">Mesin</a></li>
                                                                    </ul>
                                                                    <div class="tab-content" id="myTabContent">
                                                                            ...
                                                                            <div class="row custom-input" style="padding-left:5px;">
                                                                                <div class="row">
                                                                                    <div class="col">
                                                                                        <div class="mb-3 row">
                                                                                            <div class="col-sm-3">
                                                                                                <label class="form-label" for="bahan">Group Bahan<span style="color:red;">*</span></label>
                                                                                            </div>
                                                                                            <div class="col-sm-9">
                                                                                                <input class="form-control" id="group" name="group" list="groupOptions" onchange="getLedgerAmt(this)" placeholder="-- Pilih Group --" required>
                                                                                        ...
                                                                                        <div class="mb-3 row">
                                                                                            <label class="col-sm-3" for="remaining">Total Persediaan</label>
                                                                                            <div class="col-sm-9">
                                                                                                <input class="form-control" id="remaining" name="remaining" type="text" placeholder="0" readonly>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="mb-3 row">
                                                                                        ...
                                                                                        <div class="mb-3 row">
                                                                                            <div class="col-sm-3">
                                                                                                <label class="form-label" for="produk">Produk Jadi<span style="color:red;">*</span></label>
                                                                                            </div>
                                                                                            <div class="col-sm-9">
                                                                                                <input class="form-control" id="produk" name="produk" list="produkOptions" placeholder="-- Pilih Produk --" required>
                                                                                        ...
                                                                                        <div class="mb-3 row">
                                                                                            <label class="col-sm-3" for="quantity">Jumlah (pcs)<span style="color:red;">*</span></label>
                                                                                            <div class="col-sm-9">
                                                                                                <input class="form-control digits" id="quantity" name="quantity" type="number" placeholder="0" required>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                        ...
                                                                        <div class="tab-pane fade show" id="mesin" role="tabpanel">
                                                                            <div class="row custom-input" style="padding-left:5px;">
                                                                                <div class="row">
                                                                                    <div class="col">
                                                                                        <div class="mb-3 row">
                                                                                            <div class="col-sm-3">
                                                                                                <label class="form-label" for="machine">Mesin<span style="color:red;">*</span></label>
                                                                                            </div>
                                                                                            <div class="col-sm-9">
                                                                                                <input class="form-control" id="machine" name="machine" list="macOptions" placeholder="-- Pilih Mesin --" required>
                                                                                                <datalist id="macOptions">
                                                                                                    <?php
                                                    ...
                                                    <table class="display" id="basic-12">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th class="col-3">Hasil Produk</th>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            $query = "SELECT p.ProductionOrderID, p.CreatedOn, m.MachineName, pd.ProductName, p.QtyOrder, p.Status
                                                                    FROM productionorder p, machine m, product pd
                                                                    WHERE p.Status='0'
                                                                        AND p.MachineCD=m.MachineCD
                                                                        AND p.ProductCD=pd.ProductCD";
                                                            $result = mysqli_query($conn, $query);
                                                            while ($row = mysqli_fetch_array($result)) {
                                                                echo '
                                                                <tr>
                                                                    ...
                                                                    <td class="col-1">' . number_format($row["QtyOrder"],0,',','.') . '</td>
