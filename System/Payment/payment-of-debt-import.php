...
<head>
    ...
    <script>
        ...
        function getSuppDebt(str) {
            ...
            $.ajax({
                type: "POST",
                url: "../Process/getSuppDebtimport.php",
        ...
        function view(x) {
            document.location = "view-debt-payment-import.php?id=" + x.value;
        }
    </script>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 pe-0">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item">Pelunasan Hutang Import</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="col-md-12">
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        ?>
                                                        <button class="btn btn-outline-primary" type="button" <?php echo $canCreate ? 'data-bs-toggle="modal" data-bs-target=".modal-pelunasan-hutang"' : 'disabled'; ?>><i class="fa fa-plus-circle"></i> New</button>
                                                        <div class="modal fade modal-pelunasan-hutang" tabindex="-1"
                                                                ...
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h4 class="modal-title" id="myExtraLargeModal">
                                                                            Form Pelunasan Hutang Import</h4>
                                                                    ...
                                                                    <div class="modal-body dark-modal">
                                                                        <div class="card-body custom-input">
                                                                            <form class="row g-3"
                                                                                action="../Process/createDebtPaymentimport.php"
                                                                                method="POST">
                                                                                <div class="row">
                                                                                    <div class="col-3">
                                                                                        <div class="mb-3 row">
                                                                                            <label
                                                                                                class="col-sm-3">Supplier<span
                                                                                            ...
                                                                                            <div class="radio-form">
                                                                                                <div class="form-check">
                                                                                                    ...
                                                                                                    <label
                                                                                                        ...
                                                                                                        for="flexRadioDefault3">Tunai</label>
                                                                                                </div>
                                                                                                <div class="form-check">
                                                                                                    <input
                                                                                                        class="form-check-input"
                                                                                ...
                                                                                <div class="col-sm-12">
                                                                                    ...
                                                                                    <br>
                                                                                    <div
                                                                                        class="table-responsive custom-scrollbar signal-table">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-block" id="myTab"
                                                            ...
                                                            <li class="nav-item"><a
                                                                    ...
                                                                    href="#listPelunasan" role="tab"
                                                                    aria-controls="home" aria-selected="true">Daftar
                                                                    Pelunasan</a></li>
                                        ...
                                        <li class="nav-item"><a class="dropdown-item txt-primary f-w-500 f-18" id="close-tabs" data-bs-toggle="tab" href="#SOClose" role="tab" aria-controls="close" aria-selected="false">SO Closed</a></li>-->
                                                        ...
                                                        <div class="tab-content" id="myTabContent">
                                                            <div class="tab-pane fade show active" id="listPelunasan"
                                                                role="tabpanel">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <table class="display" id="basic-12">
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            FROM debtpaymentheaderimport dp, supplier s
