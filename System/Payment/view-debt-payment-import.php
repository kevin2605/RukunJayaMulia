                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-header">
                                    Informasi Pelunasan Hutang Import
                                </div>
                                <div class="card-body">
                                    <div class="mb-2 row">
                                        ...
                                        <div class="col-sm-6">
                                            <input class="form-control" type="text"
                                                value="<?php echo $row["DebtPaymentID"]; ?>" readonly>
                                        </div>
                                    </div>
                                    <div class="mb-2 row">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card">
                                ...
                                $queryHeader = "SELECT * FROM debtpaymentheaderimport WHERE DebtPaymentID='" . mysqli_real_escape_string($conn, $id) . "'";
                                ...
                                echo '<div class="card-header">Detail Pelunasan Hutang Import</div>';
