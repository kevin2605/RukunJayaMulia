                        ...
                        <div class="page-title">
                            ...
                            if (isset($_GET["status"])) {
                                if ($_GET["status"] == "success") {
                                    ...
                                    <p><b> Selamat! </b>Ekspedisi baru berhasil disimpan ke database.</p>
                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                ?>
                                                <button class="btn btn-outline-primary" type="button" <?php echo $canUpdate ? '' : 'disabled'; ?> data-bs-toggle="modal"
                                                    ...
                                                    <div class="modal-dialog modal-lg">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h4 class="modal-title" id="cityModalLabel">Form Ekspedisi Baru</h4>
                                                                <button class="btn-close py-0" type="button"
                                                                    data-bs-dismiss="modal" aria-label="Close"></button>
                                                            </div>
                                                            <div class="modal-body dark-modal">
                                                                <div class="card-body custom-input">
                                                                    <form class="row g-3" action="../Process/createExpedition.php" method="POST">
                                                                        <div class="col-12">
                                                                            <label class="form-label" for="namaekspedisi">Nama Ekspedisi<span style="color:red;">*</span></label>
                                                                            <input class="form-control" id="namaekspedisi" name="namaekspedisi" type="text" placeholder="..." required>
                                                                        </div>
                                                                        <div class="col-12">
                                                                        ...
                                                                        <div class="col-6">
                                                                            <label class="form-label" for="telp">No Telpon<span style="color:red;">*</span></label>
                                                                            <input class="form-control" id="telp" name="telp" type="text" placeholder="..." required>
                                                                        </div>
                                                                        <div class="col-6">
                                                                            <label class="form-label" for="npwp">NPWP<span style="color:red;">*</span></label>
                                                                            <input class="form-control" id="npwp" name="npwp" type="text" placeholder="..." required>
                                                                        </div>
                                                                        <div class="col-12">
                                                ...
                                                <ul class="dropdown-menu dropdown-block" id="myTab" role="tablist">
                                                    <li class="nav-item"><a
                                                            ...
                                                            id="home-tab" data-bs-toggle="tab" href="#daftarBarang"
                                                            role="tab" aria-controls="home" aria-selected="true">Daftar Ekspedisi</a></li>
                                                </ul> -->
                                                <hr>
                                                                ...
                                                                <table class="display" id="basic-1">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        while ($row = mysqli_fetch_array($result)) {
                                                                            echo '
                                                                            <tr>
                                                                                <td>' . $row["ExpeditionID"] . '</td>
                                                                                <td>' . $row["ExpeditionName"] . '</td>
                                                                                <td>' . $row["Address"] . '</td>
