                ...
                <div class="card-body">
                  ...
                  <form class="row g-3">
                    <div class="col-12">
                      ...
                      <input class="form-control" id="namasupplier" name="namasupplier" type="text" placeholder="-"
                        value="<?php echo $supplier["SupplierName"]; ?>" disabled>
                    </div>
                    <hr>
                        ...
                        <div class="row g-3">
                          ...
                          <div class="col-12">
                            ...
                            <textarea class="form-control" id="alamat" name="alamat" rows="3"
                              disabled><?php echo $supplier["SupplierAdd"]; ?></textarea>
                          </div>
                          <div class="col-6">
                            <label class="form-label" for="email">Email</label>
                            <input class="form-control" id="email" name="email" type="email"
                              placeholder="example@saeoil.com" value="<?php echo $supplier["Email"]; ?>" disabled>
                          </div>
                          <div class="col-3">
                            ...
                            <input class="form-control" id="telepon" name="telepon" type="text" minlength="10"
                              maxlength="12" placeholder="031xxxxxxx" value="<?php echo $supplier["Telepon"]; ?>"
                              disabled>
                          </div>
                          <div class="col-3">
                            <label class="form-label" for="hpsupplier">No. HP Supplier</label>
                            <input class="form-control" id="hpsupplier" name="hpsupplier" type="text" minlength="10"
                              maxlength="12" placeholder="031xxxxxxx" value="<?php echo $supplier["PhoneNum"]; ?>"
                              disabled>
                          </div>
                          <div class="col-6">
                            ...
                            <input class="form-control" id="namakontak" name="namakontak" type="text"
                              placeholder="example@saeoil.com" value="<?php echo $supplier["ContactName"]; ?>" disabled>
                          </div>
                          <div class="col-6">
                            ...
                            <input class="form-control" id="handphone" name="handphone" type="text" minlength="10"
                              maxlength="12" placeholder="081xxxxxxx" value="<?php echo $supplier["ContactPhone"]; ?>"
                              disabled>
                          </div>
                          <div class="col-12">
                            <label class="form-label" for="description">Description</label>
                            <textarea class="form-control" id="description" name="description" rows="2"
                              disabled><?php echo $supplier["Description"]; ?></textarea>
                          </div>
                          <div class="col-6">
                            <div class="card-wrapper border rounded-3 checkbox-checked">
                              ...
                              <div class="radio-form">
                                <div class="form-check">
                                  <input class="form-check-input" id="flexRadioDefault1" type="radio" value="1" <?php if ($supplier["Approval"] == 1) {
                                    echo "checked";
                                  } ?> name="approval" disabled>
                                  <label class="form-check-label" for="flexRadioDefault1">Yes</label>
                                </div>
                                <div class="form-check">
                                  <input class="form-check-input" id="flexRadioDefault2" type="radio" value="0" <?php if ($supplier["Approval"] == 0) {
                                    echo "checked";
                                  } ?> name="approval" disabled>
                          ...
                          <div class="col-6">
                            <div class="card-wrapper border rounded-3 checkbox-checked">
                              ...
                              <div class="radio-form">
                                <div class="form-check">
                                  <input class="form-check-input" id="flexRadioDefault3" type="radio" value="1" <?php if ($supplier["Status"] == 1) {
                                    echo "checked";
                                  } ?> name="suppStatus" disabled>
                                  <label class="form-check-label" for="flexRadioDefault3">Active</label>
                                </div>
                                <div class="form-check">
                                  <input class="form-check-input" id="flexRadioDefault4" type="radio" value="0" <?php if ($supplier["Status"] == 0) {
                                    echo "checked";
                                  } ?> name="suppStatus" disabled>
                        ...
                        <div class="row g-3">
                          <div class="col-12">
                            ...
                            <input class="form-control" id="namaNPWP" name="namaNPWP" type="text" placeholder="-"
                              value="<?php echo $supplier["NPWPName"]; ?>" disabled>
                          </div>
                          <div class="col-12">
                            ...
                            <input class="form-control" id="nomorNPWP" name="nomorNPWP" type="text" placeholder="-"
                              value="<?php echo $supplier["NPWPNum"]; ?>" disabled>
                          </div>
                          <div class="col-12">
                            <label class="form-label" for="alamatNPWP">Alamat NPWP<span
                                style="color:red;">*</span></label>
                            <input class="form-control" id="alamatNPWP" name="alamatNPWP" type="text" placeholder="-"
                              value="<?php echo $supplier["NPWPAddress"]; ?>" disabled>
                          </div>
                        </div>
                      </div>
                      <div class="tab-pane fade show" id="bank" role="tabpanel">
                        ...
                        <div class="row g-3">
                          <div class="col-4">
                            ...
                            <input class="form-control" id="beneficiaryBank" name="beneficiaryBank" list="banksOptions"
                              value="<?php echo $supplier["BankCode"]; ?>" disabled>
                          ...
                          <div class="col-6">
                            ...
                            <input class="form-control" id="norek" name="norek" type="text" minlength="10"
                              ...
                              value="<?php echo $supplier["BeneficiaryNumber"]; ?>" disabled>
                          </div>
                        </div>
                      </div>
                    </div>
