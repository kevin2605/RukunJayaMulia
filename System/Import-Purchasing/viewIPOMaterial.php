                                    ...
                                    <div class="col-xl-8">
                                        ...
                                        <div class="overflow-auto">
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $queryd = "SELECT pod.ItemCD, m.MaterialName, pod.Price, pod.Quantity, pod.QuantityReceived, pod.UnitCD 
                                                    ...
                                                    while ($rowd = mysqli_fetch_array($resultd)) {
                                                        echo '<tr>
                                                            ...
                                                            <td>' . number_format($rowd["Price"], 2, ',', '.') . '</td>
                                                            <td>' . number_format($rowd["Quantity"], 3, ',', '.') .' '. $rowd["UnitCD"] . '</td>
                                                            <td>' . number_format($rowd["QuantityReceived"], 3, ',', '.') .' '. $rowd["UnitCD"] .  '</td>
                                                            <td>' . number_format($rowd["Quantity"] - $rowd["QuantityReceived"], 3, ',', '.') . '</td>        
                                                          </tr>';
                                                        echo '<tr>
