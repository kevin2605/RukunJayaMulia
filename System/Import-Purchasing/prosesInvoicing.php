                            ...
                            if ($row["CategoryCD"] == "BB") {
                              ...
                              while ($rowd = mysqli_fetch_array($resultd)) {
                                ...
                                echo '<tr>
                                                                ...
                                                                <td><input type="number" class="form-control f-14" style="border-width:0;padding:0;" name="quantity[]" value="' . $rowd["Quantity_1"] . '" readonly></td>
                                                                <td><input type="text" class="form-control tb-label f-14" style="border-width:0;padding:0;" name="unit[]" value="' . $rowd["UnitCD_1"] . '"readonly></td>
                                                                ...
                                                                <td><input type="text" class="form-control tb-label f-14 text-end" style="border-width:0" name="subtotal[]" value="' . number_format($dpp, 2, ',', '.') . '"readonly></td>
                                                                </tr>';
                              }
                            }
                            ?>
