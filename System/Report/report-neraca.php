...
<head>
    ...
    $query = "SELECT rNeraca FROM useraccesslevel WHERE UserID = '$userID'";
    $result = mysqli_query($conn, $query);
    $row = mysqli_fetch_assoc($result);

    $hasCRUDAccess = strpos($row['rNeraca'], 'C') !== false || // Create
        strpos($row['rNeraca'], 'R') !== false || // Read
        strpos($row['rNeraca'], 'U') !== false || // Update
        strpos($row['rNeraca'], 'D') !== false;  // Delete
    ...
    <script>
        ...
        function printInv() {
            ...
            var url = "../Process/generate_neraca_pdf.php?startdate=" + encodeURIComponent(startdate) + "&enddate=" + encodeURIComponent(enddate) + "&t=" + timestamp;
