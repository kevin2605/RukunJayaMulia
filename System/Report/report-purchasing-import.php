                                            ...
                                            <tbody>
                                                <?php
                                                    ...
                                                    if(isset($_POST["btnSearch"])){
                                                        $query = "SELECT rih.RCV_InvoiceID, s.SupplierName, rih.DPP, rih.BM, rih.PPN, rih.PPH, rih.TotalAmount, rih.Status, rh.Invoice, rh.PackingList, rh.BL, rh.Insurance
                                                                  FROM importreceptioninvoiceheader rih, importreceptionheader rh, importpurchaseorderheader po,
                                                                       supplier s
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-2">
                                            <label>Total BM : <?php echo 'Rp ' .  number_format($tBM, 0, ',', '.'); ?></label>
                                        </div>
                                        <div class="col-2">
                                            <label>Total PPN : <?php echo 'Rp ' .  number_format($tPPN, 0, ',', '.'); ?></label>
                                        </div>
                                        <div class="col-2">
                                            <label>Total PPH : <?php echo 'Rp ' .  number_format($tPPH, 0, ',', '.'); ?></label>
                                        </div>
                                    </div>
                                </div>
                            </div>
