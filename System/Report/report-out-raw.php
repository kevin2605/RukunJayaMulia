...
<head>
    ...
    $query = "SELECT rMKeluar FROM useraccesslevel WHERE UserID = '$userID'";
    $result = mysqli_query($conn, $query);
    $row = mysqli_fetch_assoc($result);

    $hasCRUDAccess = strpos($row['rMKeluar'], 'C') !== false || // Create
        strpos($row['rMKeluar'], 'R') !== false || // Read
        strpos($row['rMKeluar'], 'U') !== false || // Update
        strpos($row['rMKeluar'], 'D') !== false;  // Delete
                                                ...
                                                <div class="dt-ext table-responsive custom-scrollbar">
                                                    <table class="display" id="export-button">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            $queryReception = "SELECT r.No, r.Date, r.ReferenceKey, m.MaterialName, r.FlowOut, r.Description 
                                                            FROM materialflowhistory r
                                                            JOIN material m ON r.MaterialCD = m.MaterialCD
                                                            WHERE r.FlowOut > 0";
