...
<head>
  ...
  $query = "SELECT Kategori FROM useraccesslevel WHERE UserID = '$userID'";
  $result = mysqli_query($conn, $query);
  $row = mysqli_fetch_assoc($result);

  // Cek akses CRUD dan tentukan apakah akses diizinkan
  $hasCRUDAccess = strpos($row['Kategori'], 'C') !== false || // Create
    strpos($row['Kategori'], 'R') !== false || // Read
    strpos($row['Kategori'], 'U') !== false || // Update
    strpos($row['Kategori'], 'D') !== false;  // Delete
    ...
    window.addEventListener('DOMContentLoaded', (event) => {
      ...
      if (params.error === 'access_denied') {
        Swal.fire({
          icon: 'error',
          title: 'Akses Ditolak',
          text: 'Anda tidak memiliki akses untuk mengubah data category.',
  ...
  <script>
    function editCategory(x) {
      Swal.fire({
        ...
        text: "Kategori dengan kode " + x.value + " akan diedit!",
        icon: "question",
        ...
        if (result.isConfirmed) {
          document.location = "edit-category.php?categorycd=" + x.value;
        }
      });
    }
  </script>
            ...
            <div class="page-title">
              ...
              if (isset($_GET["status"])) {
                if ($_GET["status"] == "success") {
                  ...
                  <p><b> Selamat! </b>Kategori baru berhasil disimpan ke database.</p>
                  ...
                  echo '<div class="alert txt-success border-success outline-2x alert-dismissible fade show alert-icons" role="alert">
                  <p><b> Selamat! </b>Kategori berhasil di edit dan disimpan ke database.</p>
                  <button class="btn-close" type="button" data-bs-dismiss="alert" aria-label="Close"></button>
                </div>';
                } else if ($_GET["status"] == "error-edit") {
                  echo '<div class="alert txt-danger border-danger outline-2x alert-dismissible fade show alert-icons" role="alert">
                    <p><b> Error! </b>Terjadi kesalahan saat edit kategori ke database.</p>
                    <button class="btn-close" type="button" data-bs-dismiss="alert" aria-label="Close"></button>
                  </div>';
                }
              }
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="card-body d-flex justify-content-between align-items-center">
                        ...
                        $canUpdate = false;
                        if (!empty($userID)) {
                          $query_access = "SELECT Kategori FROM useraccesslevel WHERE UserID = '$userID'";
                        ...
                        <!-- Dropdown filter di sebelah kanan -->
                        <div class="col-md-2">
                      ...
                      <div class="col-md-12">
                          ...
                          <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h4 class="modal-title" id="myExtraLargeModal">Form Kategori Baru</h4>
                                <button class="btn-close py-0" type="button" data-bs-dismiss="modal"
                                  aria-label="Close"></button>
                              </div>
                              <div class="modal-body dark-modal">
                                <div class="card-body custom-input">
                                  <form class="row g-3" action="../Process/createCategory.php" method="POST">
                                    <div class="col-6">
                                      <label class="form-label" for="kodekategori">Kode Kategori<span
                                          style="color:red;">*</span></label>
                                      <input class="form-control" id="kodekategori" name="kodekategori" type="text"
                                        placeholder="kode" required>
                                    </div>
                                    <div class="col-12">
                                      <label class="form-label" for="namakategori">Nama Kategori<span
                                          style="color:red;">*</span></label>
                                        ...
                                        <div class="radio-form">
                                          <div class="form-check">
                                            <input class="form-check-input" id="flexRadioDefault3" type="radio"
                                              name="kategoriStatus" value="1" required="">
                                          ...
                                          <div class="form-check">
                                            <input class="form-check-input" id="flexRadioDefault4" type="radio"
                                              name="kategoriStatus" value="0" required="">
                        ...
                        <div class="tab-content" id="myTabContent">
                          <div class="tab-pane fade show active" role="tabpanel">
                            <div class="table-responsive custom-scrollbar user-datatable" style="padding: 1%;">
                              <h3 style="padding-left: 1%;">Daftar Kategori</h3>
                              <table class="display" id="basic-12" style="width: 100%;">
                                <thead>
                                  <tr>
                                    <th>Kode Kategori</th>
                                    <th>Nama Kategori</th>
                              ...
                              <script>
                                document.getElementById('status-filter').addEventListener('change', function () {
                                  ...
                                  xhr.open('GET', '../Process/filter-active-category.php?status=' + status, true);
                                  xhr.onload = function () {
                                    if (this.status == 200) {
