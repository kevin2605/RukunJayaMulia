...
<head>
  ...
  <script>
    ...
    function kembangsarai() {
      document.getElementById("materialTo").value = "PC8.PKS - BAHAN PAPERCUP 8 HOT KEMBANG SARAI ( Pallet )";
    }
          ...
          <div class="page-title">
            ...
            <div class="row">
              <div class="col-sm-6 ps-0">
                <h3>MUTASI BAHAN PC 8 GENERIK</h3>
              </div>
              <div class="col-sm-6 pe-0">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item">Bahan PC 8 Generik</li>
                </ol>
              </div>
            </div>
          </div>
                          ...
                          <div class="row">
                            <div class="col-md-2 col-xs-12">
                              <div class="nav flex-column nav-pills nav-primary" id="ver-pills-tab" role="tablist"
                                ...
                                <a class="f-w-600 nav-link active" onclick="qpack()" id="ver-pills-home-tab"
                                  data-bs-toggle="pill" href="#PS12PREM" role="tab" aria-controls="ver-pills-home"
                                  aria-selected="true">PC 8 Q-PACK</a>
                                <a class="f-w-600 nav-link" onclick="scup()" id="ver-pills-components-tab"
                                  data-bs-toggle="pill" href="#PS12PREM" role="tab" aria-controls="ver-pills-components"
                                  aria-selected="false">PC 8 S-CUP</a>
                                <a class="f-w-600 nav-link" onclick="kembangsarai()" id="ver-pills-components-tab"
                                  data-bs-toggle="pill" href="#PS12PREM" role="tab" aria-controls="ver-pills-components"
                                  aria-selected="false">PC 8 KEMBANG SARAI</a>
                              </div>
                            </div>
                            <div class="col-md-10 col-xs-12">
                              <div class="tab-content" id="ver-pills-tabContent">
                                <div class="tab-pane fade show active" id="PS12PREM" role="tabpanel"
                                  ...
                                  <div class="card">
                                    <div class="card-body custom-input">
                                      <form action="../Process/createMutMatPC8G.php" method="POST">
                                        <div class="row g-3">
                                          <div class="col-4">
                                        ...
                                        <div class="row g-3">
                                          <div class="col-7">
                                            ...
                                            <input class="form-control" id="materialFrom" name="materialFrom" type="text"
                                              value="PC8.PHG - BAHAN PAPERCUP 8 HOT GENERIK" readonly>
                                          </div>
                                          <div class="col-2">
                                            <label class="form-label" for="qtyFrom">Jumlah (PLT) <span
                                                style="color:red;">*</span></label>
                                            <input class="form-control digits" id="qtyFrom" name="qtyFrom" type="number"
                                        ...
                                        <div class="row g-3">
                                          <div class="col-7">
                                            ...
                                            <input class="form-control" id="materialTo" name="materialTo" type="text"
                                              value="PC8.PQPACK - BAHAN PAPERCUP 8 HOT Q-PACK" readonly>
                                          </div>
                                          <div class="col-2">
                                            <label class="form-label" for="qtyTo">Jumlah (PLT)</label>
                                            <input class="form-control digits" id="qtyTo" name="qtyTo" type="number"
                                              readonly>
                                          </div>
                                        </div>
                                        <br>
