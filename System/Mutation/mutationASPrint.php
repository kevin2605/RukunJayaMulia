          ...
          <div class="page-title">
            ...
            <div class="row">
              <div class="col-sm-6 ps-0">
                <h3>MUTASI BAHAN ALL SHEET PRINT</h3>
              </div>
              <div class="col-sm-6 pe-0">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item">Bahan All Sheet PRINT</li>
                </ol>
              </div>
            </div>
          </div>
                            ...
                            <div class="col-md-12 col-xs-12">
                              <div class="tab-content" id="ver-pills-tabContent">
                                <div class="tab-pane fade show active" id="PS12PREM" role="tabpanel"
                                  ...
                                  <div class="card">
                                    <div class="card-body custom-input">
                                      <form action="../Process/createMutMatASP.php" method="POST">
                                        <div class="row g-3">
                                          <div class="col-4">
                                          ...
                                          <div class="col-4">
                                            <label class="form-label" for="tglmutasi">Tanggal<span style="color:red;">*</span></label>
                                            <input class="form-control" id="tglmutasi" name="tglmutasi" type="text" value="<?php echo date('Y-m-d'); ?>" readonly>
                                          </div>
                                          <div class="col-4">
                                        ...
                                        <div class="row g-3">
                                          <div class="col-7">
                                            ...
                                            <input class="form-control" id="materialFrom" name="materialFrom" type="text"
                                              value="BLH.235 - Bahan All Sheet 690 x 510" readonly>
                                          </div>
                                          <div class="col-2">
                                        ...
                                        <div class="row g-3">
                                          <div class="col-7">
                                            ...
                                            <datalist id="MLBOptions">
                                                <?php
                                                $query = "SELECT MaterialCD, MaterialName FROM material WHERE UnitCD_2 = 'FAN'";
