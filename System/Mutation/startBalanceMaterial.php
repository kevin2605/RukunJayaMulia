  ...
  <script>
    ...
    function appendProductTable(x) {
      ...
      $('#dinamis #dbody').append(`
        <tr id="row${i}">
            <td style="width:30%">
            <input type="text" class="form-control prodlist" name="materials[]" list="matOptions" onChange="appendProductTable(this)" required>
            <datalist id="prodOptions">
                <?php
                $queryp = "SELECT * FROM material WHERE Status=1";
      ...
      $.ajax({
        ...
        success: function (result) {
          ...
          $.each(res, function (index, value) {
            x.parentElement.parentElement.cells[3].getElementsByTagName("input")[0].value = value.UnitCD_2;
          });
        }
      });
    }
    ...
    function printInv(button) {
      ...
      var url = "../Process/generate_startbalancemat_pdf.php?MutationID=" + MutationID;
    ...
    function disableOtherInput(currentInput) {
        ...
        if (currentInput === flowinInput && flowinInput.value !== '') {
            flowoutInput.readOnly = true;
        } else if (currentInput === flowoutInput && flowoutInput.value !== '') {
            flowinInput.readOnly = true;
        }
        if (flowinInput.value === '') {
            flowoutInput.readOnly = false;
        }
        if (flowoutInput.value === '') {
            flowinInput.readOnly = false;
        }
    }
  </script>
              ...
              <div class="row">
                ...
                <div class="col-sm-6 pe-0">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">Mutasi Bahan</li>
                  </ol>
                </div>
              </div>
            </div>
                            ...
                            <div class="modal-content">
                              ...
                              <div class="modal-body dark-modal">
                                <div class="card-body custom-input">
                                  <form class="row g-3" action="../Process/createStartBalanceMat.php" method="POST">
                                    <div class="col-4">
