        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="card">
                <div class="card-body">
                    <div class="col-md-8">
                        <form action="../Process/editOtherExpense.php" method="POST">
                            <input type="hidden" name="blid" value="<?php echo $blid; ?>">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>Kode Akun</th>
                                    ...
                                    <?php
                                        ...
                                        while ($row = mysqli_fetch_array($result)) {
                                            echo '
                                                    ...
                                                    <td style="width: 15%;">
                                                        <input type="number" class="form-control digits debit" name="debit[]" oninput="disableOtherInput(this)" value="'.$row["Debit"].'" placeholder="0">
                                                    </td>
                                                    <td style="width: 15%;">
                                                        <input type="number" class="form-control digits credit" name="credit[]" oninput="disableOtherInput(this)" value="'.$row["Credit"].'" placeholder="0">
                                                    </td>
                                                ';
                                        }
                                    ?>
                            ...
                            <br>
                            <a class="btn btn-warning" href="other-expenses.php">Back</a>
