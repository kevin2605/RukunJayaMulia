              ...
              <div class="row">
                ...
                <div class="col-sm-6 pe-0">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">Komisi Marketing</li>
                  </ol>
                </div>
              </div>
            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 row">
                                        <label class="col-sm-3">Marketing</label>
                                        <div class="col-sm-9">
                                            <input class="form-control" id="marketing" name="marketing" type="text" <?php if(isset($_POST["marketing"])){echo 'value="'.$_POST["marketing"].'"';} ?> required>
                                        </div>
                                        </div>
                                    </div>
                                    </div>
